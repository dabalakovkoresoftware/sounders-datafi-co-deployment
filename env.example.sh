...
export CO_KEYVAL=your_base64_encoded_redis_credentials # Base64 encoded Redis credentials. Example: echo -n '{"kind":"redis","addr":"20.3.178.122:6379","username":"default","password":"ktjxak3koarbru","secure":"true"}' | base64
